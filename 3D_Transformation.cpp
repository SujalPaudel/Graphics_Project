...
int main (int argc, char *argv)
{
 ...
 break;
 case 2:
 cout << "Enter Scaling ratios along X, Y & Z\n=>"; 
 ...
 cout << "Enter Rot. Angle Alpha: ";
 cin >> Alpha;
 break;
 case 2: 
 cout << "Enter A & C: ";
 cin >> A >> C;
 cout << "Enter Rot. Angle Beta: ";
 cin >> Beta;  
 break;
 case 3: 
 cout << "Enter A & B: ";
 cin >> A >> B;
 cout << "Enter Rot. Angle Gamma: ";
 cin >> Gamma;
 break;
 case 4:  
 cout << "Enter values of x1 ,y1 & z1:\n";
 cin >> x1 >> y1 >> z1;
 cout << "Enter values of x2 ,y2 & z2:\n";
 cin >> x2 >> y2 >> z2;
 cout << "Enter Rot. Angle Theta: ";
 cin >> Theta;  
 break;              
 }
 break;
